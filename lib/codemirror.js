...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    var instance = wrapper.CodeMirror = {
      ...
      scrollPos: function() {  // TODO: replace with getScrollInfo() calls?
    ...
    function patchDisplay(from, to, intact) {
      ...
      doc.iter(from, to, function(line) {
        ...
        if (!nextIntact || nextIntact.from > j) {
          ...
          inline = getInlineWidgetForLine(line);
          if (inline)
    ...
    function updateGutter() {
      ...
      var html = [], lineNum = showingFrom, childI = 0, normalNodeI;
      ...
      if (normalNodeI != null && options.lineNumbers) {
        var node = gutterText.childNodes[normalNodeI];
